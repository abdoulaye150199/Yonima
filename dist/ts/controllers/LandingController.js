...
export class LandingController {
    ...
    async initialize() {
        ...
        window.trackPackage = this.trackPackage.bind(this);
        window.printPackageInfo = this.printPackageInfo.bind(this);
    ...
    displayPackageInfo(colis) {
        ...
        `;
        if (packageInfoDesktop)
            packageInfoDesktop.innerHTML = infoHtml;
        if (packageInfoMobile)
            packageInfoMobile.innerHTML = infoHtml;
        if (trackingResultDesktop)
            trackingResultDesktop.classList.remove('hidden');
        if (trackingResultMobile)
            trackingResultMobile.classList.remove('hidden');
        // Afficher les boutons d'impression
        const printSection = document.getElementById('print-section');
        const printSectionMobile = document.getElementById('print-section-mobile');
        if (printSection)
            printSection.classList.remove('hidden');
        if (printSectionMobile)
            printSectionMobile.classList.remove('hidden');
        // Préparer le contenu pour l'impression
        this.preparePrintContent(colis);
    }
    showProgressSection(colis) {
    ...
    hideResults() {
        ...
        const printSectionMobile = document.getElementById('print-section-mobile');
        if (trackingResultDesktop)
            trackingResultDesktop.classList.add('hidden');
        if (trackingResultMobile)
            trackingResultMobile.classList.add('hidden');
        if (progressSection)
            progressSection.classList.add('hidden');
        if (printSection)
            printSection.classList.add('hidden');
        if (printSectionMobile)
            printSectionMobile.classList.add('hidden');
    }
